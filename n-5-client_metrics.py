...
def get_metrics(dirname):
    ...
    return {
        ...
        'mean_Read2': statistics.mean(exec_lats_read3),
        'p50_Read2': np.percentile(exec_lats_read3, 50),
        'p90_Read2': np.percentile(exec_lats_read3, 90),
        'p95_Read2': np.percentile(exec_lats_read3, 95),
        'p99_Read2': np.percentile(exec_lats_read3, 99),
        'p999_Read2': np.percentile(exec_lats_read3, 99.9),
        'p9999_Read2': np.percentile(exec_lats_read3, 99.99),
        'mean_Read2': statistics.mean(exec_lats_read4),
        'p50_Read2': np.percentile(exec_lats_read4, 50),
        'p90_Read2': np.percentile(exec_lats_read4, 90),
        'p95_Read2': np.percentile(exec_lats_read4, 95),
        'p99_Read2': np.percentile(exec_lats_read4, 99),
        'p999_Read2': np.percentile(exec_lats_read4, 99.9),
        'p9999_Read2': np.percentile(exec_lats_read4, 99.99),
        ...
        'p50_Write2': np.percentile(exec_lats_write3, 50),
        'p90_Write2': np.percentile(exec_lats_write3, 90),
        'p95_Write2': np.percentile(exec_lats_write3, 95),
        'p99_Write2': np.percentile(exec_lats_write3, 99),
        'p999_Write2': np.percentile(exec_lats_write3, 99.9),
        'p9999_Write2': np.percentile(exec_lats_write3, 99.99),
        'p50_Write2': np.percentile(exec_lats_write4, 50),
        'p90_Write2': np.percentile(exec_lats_write4, 90),
        'p95_Write2': np.percentile(exec_lats_write4, 95),
        'p99_Write2': np.percentile(exec_lats_write4, 99),
        'p999_Write2': np.percentile(exec_lats_write4, 99.9),
        'p9999_Write2': np.percentile(exec_lats_write4, 99.99),
